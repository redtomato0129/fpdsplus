...
function rerouteToFpds(new_transaction_id) {
  ...
  //  const category = urlParams.get('category');
    document.location = `/ContractSearch/FpdsSearch?transaction_id=${new_transaction_id}&award_id_piid=${award_id}&parent_award_id_piid=${parent_award_id}`;
}
...
$(document).on('click', '#btnContractPastPerformance', function () {
    ...
    const naics_code = $("#naics_code").text();
    if (funding_agency == "") {
...
$(document).on('click', '#btnOkCompetitiveContractor', function () {
    ...
    var funding_sub_agency = $('#funding_sub_agency_name').text();
    const naics_code = $("#naics_code").text();
    const DeptCode = $("#funding_agency_code").text();
    const AgencyCode = $("#funding_sub_agency_code").text();
...
$(document).on('click', '#ExcelContract', function () {
    ...
    console.log(ContractDetailExcel[0])
