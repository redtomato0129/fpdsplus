                ...
                using (SqlConnection con = new SqlConnection(MainCon))
                {
                    if (body.store_procedure == "Wizard_Question1_GetTopVendorsByAgencyNAICS_DataGrid")
                    {
                        ...
                        while (rdr.Read())
                        {
                            ...
                            widgetObject.base_and_all_options_value = Convert.ToDouble(rdr["base_and_all_options_value"]);
                            widgetObject.federal_action_obligation = Convert.ToDouble(rdr["federal_action_obligation"]);
                            ...
                            widgetObject.base_and_all_options_value_k = Convert.ToDouble(rdr["base_and_all_options_value_k"]);
                            widgetObject.federal_action_obligation_k = Convert.ToDouble(rdr["federal_action_obligation_k"]);
                    ...
                    if (body.store_procedure == "Wizard_Question7_VendorsWithExpiring8aContracts_DataGrid")
                    {
                        ...
                        while (rdr.Read())
                        {
                            ...
                            widgetObject.product_or_service_code = rdr["product_or_service_code"].ToString();
                            widgetObject.product_or_service_code_description = rdr["product_or_service_code_description"].ToString();
                            widgetObject.base_and_all_options_value = rdr["base_and_all_options_value"] == DBNull.Value ? 0 : Convert.ToDouble(rdr["base_and_all_options_value"]);
                            widgetObject.base_and_all_options_value_k = rdr["base_and_all_options_value_k"] == DBNull.Value ? 0 : Convert.ToDouble(rdr["base_and_all_options_value_k"]);
                            widgetObject.federal_action_obligation = rdr["federal_action_obligation"] == DBNull.Value ? 0 : Convert.ToDouble(rdr["federal_action_obligation"]);
                            widgetObject.federal_action_obligation_k = rdr["federal_action_obligation_k"] == DBNull.Value ? 0 : Convert.ToDouble(rdr["federal_action_obligation_k"]);
                            widgetObject.type_of_contract_pricing = rdr["type_of_contract_pricing"].ToString();
                            widgetObject.solicitation_date = rdr["solicitation_date"].ToString();
                            widgetObject.action_date = rdr["action_date"].ToString();
                            widgetObject.action_date_fiscal_year = rdr["action_date_fiscal_year"].ToString();
                    ...
                    if (body.store_procedure == "Wizard_Question39_GetVendorContractHistory")
                    {
                        ...
                        while (rdr.Read())
                        {
                            ...
                            widgetObject.product_or_service_code = rdr["product_or_service_code"].ToString();
                            widgetObject.product_or_service_code_description = rdr["product_or_service_code_description"].ToString();
                            widgetObject.base_and_all_options_value = typeChecker(rdr, "base_and_all_options_value") ? 0 : Convert.ToDouble(rdr["base_and_all_options_value"]);
                            widgetObject.base_and_all_options_value_k = typeChecker(rdr, "base_and_all_options_value_k") ? 0 : Convert.ToDouble(rdr["base_and_all_options_value_k"]);
                            widgetObject.federal_action_obligation = typeChecker(rdr, "federal_action_obligation") ? 0 : Convert.ToDouble(rdr["federal_action_obligation"]);
                            widgetObject.federal_action_obligation_k = typeChecker(rdr, "federal_action_obligation_k") ? 0 : Convert.ToDouble(rdr["federal_action_obligation_k"]);
                            widgetObject.type_of_contract_pricing = rdr["type_of_contract_pricing"].ToString();
                            widgetObject.solicitation_date = rdr["solicitation_date"].ToString();
                            widgetObject.action_date = rdr["action_date"].ToString();
                            widgetObject.action_date_fiscal_year = rdr["action_date_fiscal_year"].ToString();
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(MainCon))
                {
                    ...
                    while (rdr.Read())
                    {
                        ...
                        vendorObject.base_and_all_options_value = Convert.ToDouble(rdr["base_and_all_options_value"]);
                        vendorObject.base_and_all_options_value_k = Convert.ToDouble(rdr["base_and_all_options_value_k"]);
                        vendorObject.federal_action_obligation = Convert.ToDouble(rdr["federal_action_obligation"]);
                        vendorObject.federal_action_obligation_k = Convert.ToDouble(rdr["federal_action_obligation_k"]);
                ...
                using (SqlConnection con = new SqlConnection(MainCon))
                {
                    if (body.store_procedure == "Wizard_Question_HDR_IDIQ_DrillDown")
                    {
                        ...
                        while (rdr.Read())
                        {
                            ...
                            hdrObject.product_or_service_code = rdr["product_or_service_code"].ToString();
                            hdrObject.product_or_service_code_description = rdr["product_or_service_code_description"].ToString();
                            hdrObject.base_and_all_options_value = rdr["base_and_all_options_value"] == DBNull.Value ? 0 : Convert.ToDouble(rdr["base_and_all_options_value"]);
                            hdrObject.federal_action_obligation = rdr["federal_action_obligation"] == DBNull.Value ? 0 : Convert.ToDouble(rdr["federal_action_obligation"]);
                            hdrObject.solicitation_identifier = rdr["solicitation_identifier"].ToString();
                            hdrObject.funding_agency_code = rdr["funding_agency_code"].ToString();
                            hdrObject.funding_sub_agency_code = rdr["funding_sub_agency_code"].ToString();
                            hdrObject.funding_office_code = rdr["funding_office_code"].ToString();
                            ...
                            hdrObject.awarding_office_name = rdr["awarding_office_name"].ToString();
                            hdrObject.award_type = rdr["award_type"].ToString();
                            hdrObject.base_and_all_options_value_k = rdr["base_and_all_options_value_k"] == DBNull.Value ? 0 : Convert.ToDouble(rdr["base_and_all_options_value_k"]);
                            hdrObject.federal_action_obligation_k = rdr["federal_action_obligation_k"] == DBNull.Value ? 0 : Convert.ToDouble(rdr["federal_action_obligation_k"]);
                            hdrObject.type_of_contract_pricing = rdr["type_of_contract_pricing"].ToString();
                            hdrObject.solicitation_date = rdr["solicitation_date"].ToString();
                            hdrObject.action_date = rdr["action_date"].ToString();
                            hdrObject.action_date_fiscal_year = rdr["action_date_fiscal_year"].ToString();
