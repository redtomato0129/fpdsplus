$(document).ready(function () {
  ...
  var Radiobutton = {
    labels: ["Tootache with heavy pain", "Headache", "Earache", "Sore throat", "Numb hands", "Headache", "Earache", "Sore throat", "Numb hands"],
    datasets: [{
      label: "",
      backgroundColor: [
  ...
  // });
  // Radiobutton
  var ctx = document.getElementById("radiobuttonbarChart").getContext("2d");
  Chart.register(ChartDataLabels);
  ctx.height = 500;
  ...
  // Radiobutton
  var ctx = document.getElementById("radiobuttonbarChart2").getContext("2d");
  Chart.register(ChartDataLabels);
  var myNewChartB = new Chart(ctx, {
    type: "bar",
    data: Radiobutton2,
  ...
  // Radiobutton
  var ctx = document.getElementById("radiobuttonbarChart3").getContext("2d");
  Chart.register(ChartDataLabels);
  var myNewChartB = new Chart(ctx, {
    type: "bar",
    data: Radiobutton3,
  ...
  var ctx = document.getElementById("radiobuttonbarChart4").getContext("2d");
  Chart.register(ChartDataLabels);
  var myNewChartB = new Chart(ctx, {
    type: "bar",
    data: Radiobutton4,
